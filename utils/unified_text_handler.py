...
async def unified_text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    """
    global map_session_manager, flight_session_manager, person_session_manager, movie_session_manager
    global map_text_handler_core, flight_text_handler_core, person_text_handler_core, movie_text_handler_core
...
command_factory.register_text_handler(
    ...
    description="统一文本处理器 - 智能分发地图、航班、人物和电影服务"
)