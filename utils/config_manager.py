...
class BotConfig:
    ...
    def __init__(self):
        ...
        self.fuel_cache_duration = 86400  # 24小时（scraper每天运行一次）
        self.electricity_cache_duration = 86400  # 24小时（scraper每天运行一次）
        ...
        self.nintendo_cache_duration = 86400 * 8  # 8天，配合周日清理
        ...
        self.nintendo_weekly_cleanup = True  # 默认启用
...
class ConfigManager:
    ...
    def _load_from_environment(self):
        ...
        self.config.nintendo_weekly_cleanup = get_bool_env("NINTENDO_WEEKLY_CLEANUP")
        ...
        # 平台Cookie配置（只支持部分平台）
        # 支持: Twitter, Instagram, Bilibili, Kuaishou, YouTube (通过patch支持), Tieba, TikTok, XHS
